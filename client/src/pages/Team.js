    ...
    <Container className={styles.text_center}>
      ...
      <div>
        ...
        <div>
          ...
          <div className={styles.flex_arrange}>
            ...
            <Img src={images["Vishnu_WebManager.jpeg"]} alt="EP3" name="Vishnu VS" />
            <Img src={images["Sandeep_Events_Pronites_Manager.jpg"]} alt="EP4" name="Sandeep K" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className={styles.flex_arrange}>
            <Img src={images["Saurav M_Creatives_Manager.png"]} alt="CM1" name="Saurav M" />
      ...
      <div>
        ...
        <div>
          <h4 className={styles.headings}>Sponsorship and Finance</h4>
          <div className={styles.flex_arrange}>
            <Img src={images["Shubhav_Finance_Coordinator.jpg"]} alt="SF1" name="Shubhav J" />
            <Img src={images["Minhaz_Sponsorship_Coordinator.jpg"]} alt="SF2" name="Minhaz N" />
            <Img src={images["Aditya_finance_coord.jpg"]} alt="SF3" name="Aditya N" />
        ...
        <div>
          ...
          <div className={styles.flex_arrange}>
            ...
            <Img src={images["Ekshan_hospi&infra_Coord.jpg"]} alt="HI5" name="Ekshan R" />
            <Img src={images["Varsha Hari Priya_Hospi_Infra_Coordinato.jpg"]} alt="HI6" name="Varsha B"/>
        ...
        <div>
          <h4 className={styles.headings}>Events and Pronites</h4>
          <div className={styles.flex_arrange}>
            <Img src={images["RohitV_events&pronites.JPG"]} alt="EP1" name="Rohit V" />
            ...
            <Img src={images["Nabeel_Events_pronites_coord.jpeg"]} alt="EP4" name="Nabeel M" />
            ...
            <Img src={images["Arpit_events_pronites_coordinator.jpg"]} alt="EP7" name="Arpit S" />
            ...
            <Img src={images["Pavan Brahmaji_Events _ pronites coord .jpg"]} alt="EP12" name="Pavan B"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div className={styles.flex_arrange}>
            ...
            <Img src={images["Arsalan_Creatives_coordinator.jpg"]} alt="C4" name="Arsalan S"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div className={styles.flex_arrange}>
            <Img src={images["Arpita_Multimedia_Coordinator.JPG"]} alt="M1" name="Arpita G" />
        ...
        <div>
          ...
          <div className={styles.flex_arrange}>
            <Img src={images["Vishnu_WebManager.jpeg"]} alt="WM1" name="Vishnu VS" />
