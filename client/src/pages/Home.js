    ...
    <>
      <div className="relative container ">
        <div className={`Desc top-50 text-center mx-auto ${styles.texting}`}>
          <strong>"Milan"</strong> is the annual techno-cultural-sports General
          Championship of IIT Hyderabad. It consists of 16 Sports, 19 Cultural
          and 9 technical events conducted between all the hostel blocks. In
          this second edition of Milan, presented by SBI YONO, the sports,
          cultural, and technical events will start from 25th February and will
          conclude on 6th March
        </div>
        ...
        <div className="m-3">
          ...
          <div className="w-full  mx-auto">
            <div
              ...
              data-id="6336eb78-9a40-48ee-8ae9-020972a531d8"
